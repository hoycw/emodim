function SBJ06_HFA_steps_save(SBJ,pipeline_id,an_id)
error('not updated since moving to hilbert in early Feb 2019');
...
data_out_filename = strcat(SBJ_vars.dirs.proc,SBJ,'_',an_id,'_allBands.mat');
fprintf('===================================================\n');
fprintf('--- Saving %s ------------------\n',data_out_filename);
fprintf('===================================================\n');
...
data_out_filename = strcat(SBJ_vars.dirs.proc,SBJ,'_',an_id,'_bsln.mat');
fprintf('===================================================\n');
fprintf('--- Saving %s ------------------\n',data_out_filename);
fprintf('===================================================\n');
save(data_out_filename,'-v7.3','hfa');
...
if smooth_pow_ts
    ...
    data_out_filename = strcat(SBJ_vars.dirs.proc,SBJ,'_',an_id,'_sm.mat');
    fprintf('===================================================\n');
    fprintf('--- Saving %s ------------------\n',data_out_filename);
    fprintf('===================================================\n');
    save(data_out_filename,'-v7.3','hfa');
