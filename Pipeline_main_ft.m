...
fprintf('\tChannel Diff Variance Names: %s\n',strjoin(bad_var_dif_ch,' '));
fprintf('\tTrial Variance: %s\n',num2str(bad_var_trl));
fprintf('\tTrial Diff Variance: %s\n',num2str(bad_var_dif_trl));
fprintf('==============================================================================================\n');
...
fprintf('\tVisual Preclean: %s\n',num2str(preclean_bad(:,1)'));
fprintf('\tVisual Preproc:  %s\n',num2str(preproc_bad(:,1)'));
fprintf('==============================================================================================\n');
...
fprintf(r_file,'\tTrial Variance: %s\n',num2str(bad_var_trl));
...
fprintf(r_file,'\tdata: %s\n',num2str(trial_info_KLA.bad_trials.KLA_raw));
fprintf(r_file,'\tdiff(data):  %s\n',num2str(trial_info_KLA.bad_trials.KLA_diff));
fprintf(r_file,'==============================================================================================\n');
fclose(r_file);
