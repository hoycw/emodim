...
for s = 1:numel(SBJs)
    fprintf('\n====================== %s ========================\n',SBJs{s});
%     fn_view_recon_stat(SBJs{s},pipeline_id, view_space, reg_type, show_labels, 'b', 1, thresh, 'prop_boot', 'cnts');
    fn_view_recon_stat(SBJs{s},pipeline_id, view_space, reg_type, show_labels, 'l', 0, thresh, 'prop_boot', 'cnts');
    if ~strcmp(SBJs{s},'IR68')
        fn_view_recon_stat(SBJs{s},pipeline_id, view_space, reg_type, show_labels, 'r', 0, thresh, 'prop_boot', 'cnts');
    end
